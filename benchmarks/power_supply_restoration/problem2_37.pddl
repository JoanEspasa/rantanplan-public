...
(:init 
  ...
  (disabled l31)
 (true))
(:goal (and   (= (f l1) 1.0)   (= (f l2) 1.0)   (= (f l3) 1.0)   (= (f l4) 1.0)   (= (f l5) 1.0)   (= (f l6) 1.0)   (= (f l7) 1.0)   (= (f l8) 1.0)   (= (f l9) 1.0)   (= (f l10) 1.0)   (= (f l11) 1.0)   (= (f l12) 1.0)   (= (f l13) 1.0)   (= (f l14) 1.0)   (= (f l15) 1.0)   (= (f l16) 1.0)   (= (f l17) 1.0)   (= (f l18) 1.0)   (= (f l19) 1.0)   (= (f l20) 1.0)   (= (f l21) 1.0)   (= (f l22) 1.0)   (= (f l23) 1.0)   (= (f l24) 1.0)   (= (f l28) 1.0)   (= (f l31) 1.0)   (= (f l32) 1.0)   (= (f l34) 1.0)   (= (f l35) 1.0)   (= (f l36) 1.0)   (= (f l37) 1.0)   (= (f l38) 1.0)   (= (f l39) 1.0)   (= (f l40) 1.0)   (= (f l41) 1.0)   (= (f l43) 1.0)   (= (f l44) 1.0)   (= (f l45) 1.0)  ))
)
