...
(:constants 
b0 -block  b1 -block  b2 -block  b3 -block  b4 -block  b5 -block  c0 -piston  c1 -piston  c2 -piston  )
...
(:functions (w ?x -block) ;;indicates the current weight of a block (constant)
 ...
 ;piston constraints
   ...
   (:constraint maxheightpiston
          :parameters (?p - piston)
          :condition (or (and (>= (d ?p) 0) (<= (d ?p) (l ?p))))
   )
 
 
   (:constraint downwardforce
          :parameters (?p - piston)
          :condition (or (= (f ?p) (+ (p ?p) (* (rho) (* (a ?p )(d ?p))))))
   )
...
;constraints over all the pistons 
  ...
  (:constraint totalamountoffluid
         :parameters ()
         :condition (or (= (v) (+ (*(a c2) (d c2)) (+ (*(a c1) (d c1)) (*(a c0) (d c0))))))
  )  
  (:constraint pressureequilibrium
         :parameters ()
         :condition (or (and (=(/ (f c2) (a c2)) (/ (f c1) (a c1)))(and (=(/ (f c1) (a c1)) (/ (f c0) (a c0)))(true))))
  ))
