...
(:constants 
b0 -block  b1 -block  b2 -block  b3 -block  b4 -block  b5 -block  b6 -block  c0 -piston  c1 -piston  c2 -piston  )
...
;constraints over all the pistons 
  ...
  (:constraint totalamountoffluid
         :parameters ()
         :condition (or (not (true)) (= (v) (+ (*(a c2) (d c2)) (+ (*(a c1) (d c1)) (*(a c0) (d c0))))))
  )  
  (:constraint pressureequilibrium
         :parameters ()
         :condition (or (not (true)) (and (=(/ (f c2) (a c2)) (/ (f c1) (a c1)))(and (=(/ (f c1) (a c1)) (/ (f c0) (a c0)))(true))))
  ))
